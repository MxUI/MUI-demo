...
t_sampler_gauss = mui4py.ChronoSamplerGauss(0.0, 0.0)
t_sampler_gauss = mui4py.ChronoSamplerSum(0.0, 0.0)
t_sampler_gauss = mui4py.ChronoSamplerMean(0.0, 0.0)

# Spatial samplers
s_sampler_exact = mui4py.SamplerExact()
s_sampler_gauss = mui4py.SamplerGauss(1.0, 1.0)
s_sampler_gauss = mui4py.SamplerMovingAverage(bbox)
